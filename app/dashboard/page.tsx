...
import { Activity, DollarSign, Users, Globe } from "lucide-react"
        ...
        <Card className="col-span-3">
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                <div className="ml-4 space-y-1">
                  <p className="text-sm font-medium leading-none">New website published</p>
                  <p className="text-sm text-muted-foreground">15 minutes ago</p>
                </div>
              </div>
              <div className="flex items-center">
                <div className="ml-4 space-y-1">
                  <p className="text-sm font-medium leading-none">SEO report generated</p>
